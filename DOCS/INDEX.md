# Proje Dokümantasyon Dizini

**Umay** framework'ünün eksiksiz tersine mühendislik dokümantasyonu — sıfırdan geliştirilmiş minimal bir PHP MVC framework'ü (PHP ≥ 8.2). Bu dizin, oluşturulan tüm raporlara bağlantılar içerir.

## Genel Raporlar

### Grup A — Mimari ve Yaşam Döngüsü
- [Mimari](ARCHITECTURE.md)
- [Framework Özellikleri](FRAMEWORK_FEATURES.md)
- [İstek Yaşam Döngüsü](REQUEST_LIFECYCLE.md)
- [Önyükleme Süreci](BOOT_PROCESS.md)
- [Paket Yapısı](PACKAGE_STRUCTURE.md)

### Grup B — Çekirdek Alt Sistemler
- [Yönlendirme Sistemi](ROUTING_SYSTEM.md)
- [Konteyner](CONTAINER.md)
- [Servis Sağlayıcılar](SERVICE_PROVIDERS.md)
- [Middleware (Ara Katman)](MIDDLEWARE.md)
- [Veritabanı](DATABASE.md)
- [ORM](ORM.md)

### Grup C — Çalışma Zamanı ve Konfigürasyon Servisleri
...
### Grup D — Güvenlik ve Erişim Kontrolü
...
### Grup E — Sunum
- [Görünüm Motoru](VIEW_ENGINE.md)
- [Şablon Motoru](TEMPLATE_ENGINE.md)

### Grup F — Tanılama ve Performans
- [Hata Yönetimi](ERROR_HANDLING.md)
- [Günlükleme](LOGGING.md)
- [Performans ve Profilleme](PERFORMANCE.md)

### Grup G — Grafikler
- [Bağımlılık Grafiği](DEPENDENCY_GRAPH.md)
- [Sınıf Grafiği](CLASS_GRAPH.md)
- [Çağrı Grafiği](CALL_GRAPH.md)

## Dizin ve Matris Raporları
- [Sınıf Dizini](CLASS_INDEX.md)
- [Metot Dizini](METHOD_INDEX.md)
- [Rota Matrisi](ROUTE_MATRIX.md)
- [Konfigürasyon Matrisi](CONFIGURATION_MATRIX.md)
- [Servis Matrisi](SERVICE_MATRIX.md)
- [Sözlük](GLOSSARY.md)

## Kök
- [Kök Dizin Raporu](ROOT.md)
- Dosyalar: [.env.example](.env.example.md) · [.gitattributes](.gitattributes.md) · [.gitignore](.gitignore.md) · [.htaccess](.htaccess.md) · [composer.json](composer.json.md) · [composer.lock](composer.lock.md) · [LICENSE](LICENSE.md) · [phpstan.neon](phpstan.neon.md) · [phpstan-baseline.neon](phpstan-baseline.neon.md) · [phpunit.xml](phpunit.xml.md)

## Dizin ve Dosya Raporları

### app/ — [dir](app/index.md)
- [.htaccess](app/.htaccess.md)
- Kontrolcüler/ — [dir](app/Controllers/index.md) · [Controller](app/Controllers/Controller.md)
- Middleware/ — [dir](app/Middleware/index.md) · [ThrottleMiddleware](app/Middleware/ThrottleMiddleware.md)
- Modeller/ — [dir](app/Models/index.md) · [User](app/Models/User.md)
- Sağlayıcılar/ — [dir](app/Providers/index.md) · [EventServiceProvider](app/Providers/EventServiceProvider.md) · [RouteServiceProvider](app/Providers/RouteServiceProvider.md)
- Servisler/ — [dir](app/Services/index.md)
