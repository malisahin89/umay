...
<section class="relative">
    ...
    <div class="mx-auto max-w-4xl px-6 pb-4 pt-20 text-center sm:pt-24">
        <nav class="flex items-center justify-center gap-1.5 text-xs font-medium text-zinc-400">
            ...
            <i class="fa-solid fa-angle-right text-[9px]"></i><span class="text-zinc-500">Yazılar</span>
        </nav>
        <p class="mt-6 text-xs font-semibold uppercase tracking-[0.2em] text-violet-600">Blog</p>
        <h1 class="font-display mt-1 text-4xl font-semibold tracking-tight text-zinc-900 sm:text-5xl">Tüm Yazılar</h1>
    ...
    <?php if (count($categories) > 0) { ?>
        <div class="mx-auto max-w-4xl px-6">
            <div class="flex flex-wrap justify-center gap-2">
                <a href="/<?= $this->e($locale) ?>/blog" class="rounded-full bg-zinc-900 px-4 py-1.5 text-sm font-semibold text-white">Tümü</a>
